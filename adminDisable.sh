...
if [[ -f /var/uits/userToRemove ]]; then
	...
	defaults write /Library/LaunchDaemons/com.yourcompany.adminDisable.plist disabled -bool true
	echo "going to unload"
	launchctl unload -w /Library/LaunchDaemons/com.yourcompany.adminDisable.plist
	echo "Completed"
	rm -f /Library/LaunchDaemons/com.yourcompany.adminDisable.plist
fi
exit 0
