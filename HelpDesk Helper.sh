...
runCommand="button returned of (display dialog \"$displayInfo\" with title \"Computer Information\" with icon file posix file \"/Library/Application Support/FroggTech/LoginLogo.png\" buttons {\"OK\"} default button {\"OK\"})"
...
## Run additional commands #####
	...
	#sudo -u "$currentUser" /usr/bin/open "mailto:helpdesk@grcs.org?subject=Computer Information ($serialNumber)&body=$displayInfo"
